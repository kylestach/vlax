...
class Model(nn.Module):
    ...
    def embed_image_and_text(
        self, image, text, *, input_mask=None, mask_ar=None, train=False
    ):
    ...
    def _fallback_prefill_cache(self, x, input_mask, mask_ar, cache_size):
        ...
        x = jnp.pad(
            jnp.where(input_mask[..., None], x, 0), [(0, 0), (0, pad_size), (0, 0)]
        )
        mask_ar = jnp.pad(jnp.where(input_mask, mask_ar, 0), [(0, 0), (0, pad_size)])
